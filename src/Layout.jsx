...
export function Layout() {
  ...
  return (
    <>
      <div className={`flex h-screen bg-gradient-to-b from-blue to-light-blue `}> {/* //fullscreen */}
        <div className={`flex ${sidebarOpen 
          ? "w-[32%] 3xl:w-[25%]" 
          : "bg-white"} `}> {/* left sidebar + menu */}
          <div className={`flex ${sidebarOpen
                ? "w-1/4 rounded-none"
        ...
        <div className={`flex flex-col grow bg-white  ${ sidebarOpen
              ? "w-[68%] max-3xl:my-[5vh] rounded-l-[22px]" 
              : "rounded-none" } `}>{/* outlet container */}
          <Outlet />
        </div>
